  ...
  const DICT = {
    es: {
      ui: {
        ...
        'nav.names': 'Nombres',
        'names.title': 'Sugerencias de título',
        'names.note': 'Los patrones de titulación están documentados; los títulos concretos no. Esto es una ayuda creativa, no un dato del juego: ninguna de estas sugerencias afecta a la puntuación.',
        'names.patternsTitle': 'Patrones que se aplican',
        'names.topic': 'Tema',
        'names.genre': 'Género',
        'names.more': 'Generar otros',
        'names.copy': 'Copiar',
        'names.copied': 'Copiado',
        'names.eggTitle': 'Nombres que activan un easter egg',
        'names.eggNote': 'Estos sí están documentados: el juego los reconoce literalmente.',
        'pattern.colonSub': 'Título: Subtítulo',
        'pattern.ofFormula': 'Fórmula «X de Y»',
        'pattern.topicGenre': 'Tema y género',
        'pattern.genreOfTopic': 'Género y tema',
        'pattern.poolPair': 'Par de repertorios',
        'pattern.topicDash': 'Tema con guion',
        'pattern.topicPool': 'Tema y repertorio',
        'pattern.sequel': 'Secuela numerada',
        'matrix.catalog': 'Catálogo completo de temas',
        'matrix.catalogNote': 'Los {n} temas del juego con su idoneidad por género y por público. Los 12 que la guía publica con multiplicador numérico llevan la marca ◆ y aparecen arriba en la matriz. Para el resto la fuente solo documenta las combinaciones excelentes: un hueco significa «sin dato publicado», no «mala combinación».',
        'matrix.search': 'Buscar tema…',
        'matrix.filterGenre': 'Filtrar por género',
        'matrix.colTopic': 'Tema',
        'matrix.colGenres': 'Géneros idóneos',
        'matrix.colAudience': 'Público',
        'matrix.exact': 'Con multiplicador exacto',
        'matrix.count': '{n} temas',
        'rating.3': 'Excelente',
        'rating.2': 'Bueno',
        'rating.1': 'Aceptable',
        'rating.-1': 'Malo',
        'rating.-2': 'Pésimo',
        'rating.0': 'Sin dato',
        'platforms.suitability': '¿Qué plataforma me conviene?',
        'platforms.suitabilityNote': 'Elige género y público y verás las plataformas ordenadas por idoneidad. La afinidad de género procede de las fuentes citadas; el multiplicador de público solo aparece donde está publicado.',
        'platforms.pickGenre': 'Género',
        'platforms.pickAudience': 'Público objetivo',
        'platforms.pickYear': 'Año de partida',
        'platforms.anyYear': 'Cualquiera',
        'platforms.affine': 'Afín al género',
        'platforms.notAffine': 'Sin afinidad documentada',
        'platforms.available': 'Disponible',
        'platforms.notYet': 'Aún no disponible',
        'platforms.rank': 'Idoneidad',
      ...
      genre: { action: 'Acción', adventure: 'Aventura', rpg: 'Rol', simulation: 'Simulación', strategy: 'Estrategia', casual: 'Casual' },
      ...
      topic: {
        ...
        space: 'Espacial', spy: 'Espionaje', superheroes: 'Superhéroes', timeTravel: 'Viaje en el tiempo',
        rhythm: 'Ritmo', werewolf: 'Hombres lobo', zombies: 'Zombis', school: 'Escuela',
        ...
        abstract: 'Abstracto', assassin: 'Asesino', colonization: 'Colonización',
        comedy: 'Comedia', construction: 'Construcción', cooking: 'Cocina', crime: 'Crimen',
        dance: 'Danza', disasters: 'Desastres', dystopian: 'Distopía', expedition: 'Expedición',
        extremeSports: 'Deportes extremos', farming: 'Agricultura', gameDev: 'Desarrollo de juegos',
        hospital: 'Hospital', madScience: 'Ciencia loca', movies: 'Cine', mythology: 'Mitología',
        ninja: 'Ninja', racing: 'Carreras', startups: 'Startups', surgery: 'Cirugía',
        technology: 'Tecnología', thief: 'Ladrón', virtualPet: 'Mascota virtual'
      },
      platform: {
    ...
    en: {
      ui: {
        ...
        'nav.names': 'Names',
        'names.title': 'Title suggestions',
        'names.note': 'The naming patterns are documented; the specific titles are not. This is a creative aid, not game data: none of these suggestions affects your score.',
        'names.patternsTitle': 'Patterns applied',
        'names.topic': 'Topic',
        'names.genre': 'Genre',
        'names.more': 'Generate more',
        'names.copy': 'Copy',
        'names.copied': 'Copied',
        'names.eggTitle': 'Names that trigger an easter egg',
        'names.eggNote': 'These ones are documented: the game recognises them literally.',
        'pattern.colonSub': 'Title: Subtitle',
        'pattern.ofFormula': '“X of Y” formula',
        'pattern.topicGenre': 'Topic and genre',
        'pattern.genreOfTopic': 'Genre and topic',
        'pattern.poolPair': 'Word-pool pair',
        'pattern.topicDash': 'Topic with dash',
        'pattern.topicPool': 'Topic and word pool',
        'pattern.sequel': 'Numbered sequel',
        'matrix.catalog': 'Complete topic catalogue',
        'matrix.catalogNote': 'All {n} topics in the game with their genre and audience suitability. The 12 the guide publishes with a numeric multiplier are marked ◆ and appear in the matrix above. For the rest, the source documents only the excellent combinations: a gap means “no published data”, not “bad combination”.',
        'matrix.search': 'Search topic…',
        'matrix.filterGenre': 'Filter by genre',
        'matrix.colTopic': 'Topic',
        'matrix.colGenres': 'Suitable genres',
        'matrix.colAudience': 'Audience',
        'matrix.exact': 'Has exact multiplier',
        'matrix.count': '{n} topics',
        'rating.3': 'Excellent',
        'rating.2': 'Good',
        'rating.1': 'Acceptable',
        'rating.-1': 'Poor',
        'rating.-2': 'Terrible',
        'rating.0': 'No data',
        'platforms.suitability': 'Which platform suits me?',
        'platforms.suitabilityNote': 'Pick a genre and audience to see platforms ranked by suitability. Genre affinity comes from the cited sources; the audience multiplier only appears where it is published.',
        'platforms.pickGenre': 'Genre',
        'platforms.pickAudience': 'Target audience',
        'platforms.pickYear': 'Game year',
        'platforms.anyYear': 'Any',
        'platforms.affine': 'Affine to genre',
        'platforms.notAffine': 'No documented affinity',
        'platforms.available': 'Available',
        'platforms.notYet': 'Not available yet',
        'platforms.rank': 'Suitability',
      ...
      topic: {
        ...
        abstract: 'Abstract', assassin: 'Assassin', colonization: 'Colonization',
        comedy: 'Comedy', construction: 'Construction', cooking: 'Cooking', crime: 'Crime',
        dance: 'Dance', disasters: 'Disasters', dystopian: 'Dystopian', expedition: 'Expedition',
        extremeSports: 'Extreme sports', farming: 'Farming', gameDev: 'Game dev',
        hospital: 'Hospital', madScience: 'Mad science', movies: 'Movies', mythology: 'Mythology',
        ninja: 'Ninja', racing: 'Racing', startups: 'Startups', surgery: 'Surgery',
        technology: 'Technology', thief: 'Thief', virtualPet: 'Virtual pet'
      },
      platform: {
        pc: 'PC', govodore: 'Govodore G64', tes: 'TES', masterV: 'Master V', gameling: 'Gameling',
        venaGear: 'Vena Gear', venaOasis: 'Vena Oasis', superTes: 'Super TES', playsystem: 'Playsystem',
